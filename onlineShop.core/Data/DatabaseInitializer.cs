...
namespace onlineShop
{
    ...
    public class DatabaseInitializer
    {
        ...
        {
            productsManager.TryAddProduct(new Book("Master and Margarita", 10, "book", "green", new Size(3, 3, 3, 150), 400, "Bulgakov", "novel"), 13);
            productsManager.TryAddProduct(new Book("Pride and Prejudice", 11, "book", "blue", new Size(3, 3, 3, 160), 300, "Jane Austen", "novel"), 13);
            productsManager.TryAddProduct(new Book("Happy yenotishches", 10, "book, snow", "green", new Size(3, 3, 3, 150), 400, "Yen McNotishe", "fairy tale"), 15);
            ...
            productsManager.TryAddProduct(new Book("Christmas White", 13, "book", "green", new Size(3, 3, 3, 150), 400, "Oscar", "fairy tale"), 13);
            productsManager.TryAddProduct(new Book("Guide for painting eggs", 9, "book, ester, bunny", "white", new Size(3, 3, 3, 150), 400, "Notith", "learning"), 13);
            ...
            productsManager.TryAddProduct(new Book("Love your Valentine", 99, "book, love, valentine, heart", "red", new Size(3, 3, 3, 160), 300, "John Azimov", "learning"), 13);
